...
class QuestParser {
    ...
    public static void main(String[] args) throws IOException { 
        String path = "C:/Users/Tejashree/Desktop/Study/spring'16/NLP/projectNLP/separatedIntoLinesData/set1/a1Separated.txt";
        String fname = "C:/Users/Tejashree/Desktop/Study/spring'16/NLP/projectNLP/separatedS/set1/a1SeparatedS.txt";
  ...
  private static List<String> getNounPhrases(Tree parse) {
    ...
    TregexPattern pattern = TregexPattern.compile("@S");
